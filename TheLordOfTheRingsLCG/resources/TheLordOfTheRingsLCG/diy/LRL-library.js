...
function drawArtist(g,diy){
	...
	Artist_box.drawAsSingleLine(g,diy.settings.getRegion(checkKey('Artist-region')));
}
function drawCopyright(g,diy){
	Copyright_box.markupText = $Copyright;
	Copyright_box.drawAsSingleLine(g,diy.settings.getRegion(checkKey('Copyright-region')));
}
function drawCollectionInfo(g,diy){
	CollectionInfo_box.markupText = $CollectionInfo;
	CollectionInfo_box.drawAsSingleLine(g,diy.settings.getRegion(checkKey('CollectionInfo-region')));
}
