...
//3: a\u00f1adido ShipObjective (prog)
function createTemplates( diy ){
	diy.frontTemplateKey = 'ObjectiveAlly-front';
...
/* TEMPLATE */
	var combo = new Array('Standard','Ship','Boon','Gold','CustomDifficulty');
...
/* TEMPLATE */
	...
	case 'Gold':
		...
		sheet.paintImage(g,TemplateDeco_tinter.getTintedImage(),Card+'-deco-region');
		break;
...
/* STATS */
	sheet.paintImage(g,ImageUtils.get('TheLordOfTheRingsLCG/number/'+$Willpower+'.png'),checkKey('Willpower-region'));
